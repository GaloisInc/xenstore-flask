...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2b722f9e15aeb47f35ebf12becbe0103) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Types"; "Path_db"; "Security"; "Policy"; "Hooks"];
                      lib_pack = true;
                      lib_internal_modules = ["Policy_gen"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "xenstore-flask";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\031bguRq/\178x\002\004F\130\173l\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
