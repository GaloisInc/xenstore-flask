...
(* OASIS_START *)
(* DO NOT EDIT (digest: b5dc41f7c4131a4043c076113928263d) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Types"; "Path_db"; "Security"; "Policy"];
                      lib_pack = true;
                      lib_internal_modules = ["Policy_gen"];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tests";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "xs_flask"];
                   ...
                   {exec_custom = false; exec_main_is = "path_db_test.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some ">\133\239jL\165I\235s\235\236\129\143u\247\222";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
