...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7e2505a7eaedef9e30002f5eabf562db) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xenstore-policy", None);
                           FindlibPackage ("cpio-odc", None)
                        ];
                      bs_build_tools =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "q\153\015Q^\197\141L@\183\227^\160\200NU";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
